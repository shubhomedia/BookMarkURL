...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Add Page of Bookmark </title>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="create.php"><span class="glyphicon glyphicon-save"></span> Add</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="well well-lg">
                        <form role="user" action="store.php" method="post">
