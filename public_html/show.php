...
<!--                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($bookmarks as $bookmark) {
                                ...
                                <tr>
                                    <td><?php echo $slno; ?></td>
                                    <td><a href="show.php?id=<?php echo $bookmark['title'];?>"><?php echo $bookmark['title']; ?></a></td>
                                    <td><?php echo $bookmark['url']; ?></td>
                                    <td><a href="single_view.html"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-zoom-in"></span> View</button></a></td>
                                    <td><a href="edit.html"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</button></a></td>
                                    <td><a href="#"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</button></a></td>
                                    <td><a href="#"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span> Trash/Recover</button></a></td>
                    ...
                    <div class="well well-lg">
                        <h3>Bookmark Title :<?php echo " ". $bookmarks['title']; ?></h3>
                        <h3>URL :<?php echo " ". $bookmarks['url']; ?></h3>
