...
<!--                                    <td><a href="edit.php?id=<?php echo $bookmark['id']; ?>"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</button></a></td>-->
                                    <td><a href="recover.php?id=<?php echo $bookmark['id']; ?>"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-registration-mark"></span> Recover</button></a></td>
                                    <td>
